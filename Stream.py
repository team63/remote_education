...
selection = st.sidebar.radio(
    ...
    [
        ...
        'Estadisticas descriptivas del modelo propuesto',
        'Modelo',
...
if (selection != 'Introducción') & (selection != 'Estadisticas descriptivas'):
    ...
    risk = st.sidebar.slider(
        ...
        min_value=math.ceil(Data_Base[Data_Base.Ano == 2019]['PUNT_GLOBAL'].quantile(0.05)),
        max_value=math.ceil(UmbralDefault),
        value=math.ceil(Data_Base[Data_Base.Ano == 2019]['PUNT_GLOBAL'].quantile(0.5)),
        step=1
    )
...
if (selection == 'Estadisticas descriptivas del modelo propuesto'):
    components.iframe(
